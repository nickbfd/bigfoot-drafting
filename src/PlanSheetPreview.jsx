...
export default function PlanSheetPreview() {
  ...
  return (
    <>
      ...
      >
        {
          <img src="https://github.com/nickbfd/bigfoot-drafting/blob/main/public/plans/samplePlan.png" className="bfd-sheet-preview__img" alt="Sample floor plan sheet showing room layout and dimensions"/>
        }
          ...
          >
            ...
            >
...

              {
                ...
                <iframe src="https://github.com/nickbfd/bigfoot-drafting/blob/main/public/plans/SamplePlan.pdf" title="Sample plan sheet" className="bfd-sheet-modal__pdf" />
              }
