...
export default function PlanSheetPreview() {
  ...
  return (
    <>
      ...
      >
        {
          <img src="/plans/samplePlan.png" className="bfd-sheet-preview__img" alt="Sample floor plan sheet showing room layout and dimensions"/>
        }
          ...
          >
            ...
            >
...

              {
                ...
                <iframe src="/plans/SamplePlan.pdf" title="Sample plan sheet" className="bfd-sheet-modal__pdf" />
              }
